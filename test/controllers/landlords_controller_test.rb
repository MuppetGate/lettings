...
class LandlordsControllerTest < ActionController::TestCase
  ...
  test "should create landlord" do
    assert_difference('Landlord.count') do
      post :create, landlord: { address: @landlord.address, email_address: @landlord.email_address, first_name: @landlord.first_name, initials: @landlord.initials, notes: @landlord.notes, postcode: @landlord.postcode, short_name: @landlord.short_name, surname: @landlord.surname, telephone_number: @landlord.telephone_number, title: @landlord.title }
    end
  ...
  test "should update landlord" do
    patch :update, id: @landlord, landlord: { address: @landlord.address, email_address: @landlord.email_address, first_name: @landlord.first_name, initials: @landlord.initials, notes: @landlord.notes, postcode: @landlord.postcode, short_name: @landlord.short_name, surname: @landlord.surname, telephone_number: @landlord.telephone_number, title: @landlord.title }
    assert_redirected_to landlord_path(assigns(:landlord))
  end
